...
window.DocumentSearchManager = {
  ...
  createSearchOverlay() {
    ...
    const searchIcon = window.SVGIcons ? window.SVGIcons.getHTML('search') : '🔍';
    const prevIcon = window.SVGIcons ? window.SVGIcons.getHTML('chevronUp') : '▲';
    const nextIcon = window.SVGIcons ? window.SVGIcons.getHTML('chevronDown') : '▼';
    this.searchOverlay.innerHTML = `
      <div class="search-box">
        ...
        <div class="search-controls">
          <button class="search-nav-btn" data-dir="prev" title="Previous (Shift+Enter)">${prevIcon}</button>
          <button class="search-nav-btn" data-dir="next" title="Next (Enter)">${nextIcon}</button>
