/**
 * SVG Icon Library
 * Professional scalable icons to replace emoji
 */

window.SVGIcons = {
  // Badge icon for MD badge
  markdown: `
  ...
  // Moon icon for dark mode (dark mode)
  moon: `
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  create(iconName, className = '') {
    ...
    div.innerHTML = this[iconName] || this.close;
  ...
  getHTML(iconName) {
    return this[iconName] || this.close;
  }
};
