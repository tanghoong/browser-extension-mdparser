...
window.TTSManager = {
  ...
  // Load voices and select the default system voice or first English voice available
  loadVoices() {
    const setVoice = () => {
      ...
      // Prefer high-quality voices (Google voices are typically high quality)
      // Use system default if available, otherwise first English voice
